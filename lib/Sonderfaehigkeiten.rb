...
Pflanze2Sonderfaehigkeit = Sonderfaehigkeit.new([:pflanze, :pflanze], "+17 Schaden gegen Wassergeister; -2 Schaden gegen Feuergeister an", Gruen, Cyan, ["     ", "     ", "     "], false, A_NORMAL)
...
Reichweite2Sonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :wasser], "+2 Reichweite", Gelb, Gruen, ["  V  ", "     ", "  A  "], false, A_NORMAL)
VergiftungsSonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :pflanze, :pflanze], "Vergiftet Gegner 100 Runden lang und verdoppelt dadurch den Schaden insgesamt. Versucht Unvergiftete zu treffen.", Gruen, Blau, ["  :  ", "     ", "  :  "], true, A_NORMAL)
StaerkeWachsenSonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :pflanze, :wasser], "Wird jede Runde 5% stärker (linear)", Schwarz, Cyan, ["  T  ", "     ", "  U  "], false, A_NORMAL)
SplashSonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :wasser, :wasser], "Trifft alle Gegner auf einem Feld. Zielt auf Felder mit möglichst vielen Gegnern", Magenta, Gruen, ["  @  ", "     ", "  @  "], false, A_NORMAL)
Pflanze3Sonderfaehigkeit = Sonderfaehigkeit.new([:pflanze, :pflanze, :pflanze], "+36 Schaden gegen Wassergeister; -2 Schaden gegen Feuergeister an", Rot, Gruen, ["  O  ", "     ", "  A  "], true, A_NORMAL)
...
VereisungsSonderfaehigkeit = Sonderfaehigkeit.new([:pflanze, :wasser, :wasser], "Lässt Gegner mit einer W'keit von 1.5% hundert Runden lang einfrieren. Versucht uneingefrorene Ziele zu treffen", Weiss, Cyan, ["  *  ", "  M  ", "  *  "], true, A_NORMAL)
...
Reichweite4Sonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :feuer, :wasser], "+x Reichweite, +10x% Staerke, -x/10 Schussrate, wobei x die Anzahl der Türmen mit identischen Upgrades ist", Gruen, Cyan, ["\\\\ //", "     ", "// \\\\"], false, A_NORMAL)
...
ReichweiteKoenigSonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :wasser, :wasser, :wasser], "+1 Reichweite für alle Verteidiger in Reichweite", Rot, Blau, ["|    ", "|    ", "L____"], true, A_NORMAL)
VersteinerungSonderfaehigkeit = Sonderfaehigkeit.new([:pflanze, :pflanze, :pflanze, :pflanze], "2.25% Chance auf Versteinerung", Weiss, Cyan, ["OO OO", "     ", "OO OO"], true, A_NORMAL)

...
VereisungsSonderfaehigkeit = Sonderfaehigkeit.new([:pflanze, :wasser, :wasser], "Lässt Gegner mit einer W'keit von 1% hundert Runden lang einfrieren. Versucht uneingefrorene Ziele zu treffen", Weiss, Cyan, ["  *  ", "  M  ", "  *  "], true)
...
ProzentSchadenSondefaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :pflanze, :pflanze],  "Gegnerische Leben * 0.015 Mal mehr Schaden. Attackiert bevorzugt stärkere Gegner", Gelb, Cyan, ["   %%", "     ", "%%   "], false)
SchnellLaden2Sondefaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :pflanze, :wasser], "-6 Schussrate, 40% weniger Schaden", Gelb, Cyan, ["ZZ ZZ", "     ", "ZZ ZZ"], false)
HeilungsSonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :wasser, :wasser], "Heilt dich um 1 Lebenspunkt, wenn ein Baum mit dieser Fähigkeit einen Gegner besiegt. Wenn dieser Upgrade gemacht wird, bekommst du 10 Lebenspunkte", Rot, Cyan, ["/\\ /\\", "\\   /", " \\_/  "], false)
...
VersteinerungSonderfaehigkeit = Sonderfaehigkeit.new([:pflanze, :pflanze, :pflanze, :pflanze], "3.25% Chance auf Versteinerung", Weiss, Cyan, ["OO OO", "     ", "OO OO"], true)
...
AllroundSonderfaehigkeit = Sonderfaehigkeit.new([:pflanze, :pflanze, :wasser, :wasser], "+1 Reichweite; -2 Schussrate, +30% Schaden", Schwarz, Cyan, ["__ ==", "     ", "== __"], false)

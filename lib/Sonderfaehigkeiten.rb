...
ProzentSchadenSondefaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :pflanze, :pflanze],  "Grundschaden um 1.5% der Gegnerischen Lebenspunkte erhöht. Attackiert bevorzugt stärkere Gegner", Gelb, Cyan, ["   %%", "     ", "%%   "], false)
SchnellLaden2Sondefaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :pflanze, :wasser], "-6 Schussrate, halbiert Schaden", Gelb, Cyan, ["ZZ ZZ", "     ", "ZZ ZZ"], false)
HeilungsSonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :wasser, :wasser], "Heilt dich um 1 Lebenspunkt, wenn ein Baum mit dieser Fähigkeit einen Gegner besiegt", Rot, Cyan, ["/\\ /\\", "\\   /", " \\_/  "], false)

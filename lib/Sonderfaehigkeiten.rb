...
StaerkeWachsenSonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :pflanze, :wasser], "Wird jede Runde 5% stärker (linear)", Schwarz, Cyan, ["  T  ", "     ", "  U  "], false)
...
BrandSonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :feuer, :pflanze], "Erzündet dauerhaft ein Feuer auf dem Zielfeld. #{Sonderfaehigkeit::GegnerVerbrennFaktor} Feuer verursachen bei jedem Feind, der das Feld betritt 1 Lp Schaden. Gegner die durch das Feuer verletzt werden, werden dauerhaft 3% langsamer.", Rot, Cyan, ["     ", "     ", "ÜÜ ÜÜ"], false)
Reichweite4Sonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :feuer, :feuer, :wasser], "+x Reichweite, +10x% Staerke, -x/10 Schussrate, wobei x die Anzahl der Türmen mit identischen Upgrades ist", Gruen, Cyan, ["\\\\ //", "     ", "// \\\\"], false)
...
StaerkeLevel2Sonderfaehigkeit = Sonderfaehigkeit.new([:feuer, :pflanze, :pflanze, :wasser], "*2 Schaden; Wenn es mindestens #{Sonderfaehigkeit::ErhoehungsAnzahl} Türme gibt, erhöht sich der Schaden von allen Türmen um 10*log10(x)%, wobei x der maximale Schaden ist, den einer dieser Türme verursacht hat", Schwarz, Cyan, ["XX XX", "     ", "YW WY"], false)
...
VersteinerungSonderfaehigkeit = Sonderfaehigkeit.new([:pflanze, :pflanze, :pflanze, :pflanze], "2.25% Chance auf Versteinerung", Weiss, Cyan, ["OO OO", "     ", "OO OO"], true)
